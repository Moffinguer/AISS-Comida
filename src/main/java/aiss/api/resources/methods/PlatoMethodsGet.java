...
public class PlatoMethodsGet {
	...
	public static Collection<Plato> setOrder(List<Comparator> ordenamiento,
	...
	public static Collection<Plato> getPlatosPorTipoDieta(String tipoDieta, 
			Collection<Plato> platos, DietaRepository repository) {
